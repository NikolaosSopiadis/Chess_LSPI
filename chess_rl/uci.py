...
def uci_to_move(board: Board, uci: str) -> Move:
    ...
    object, including flags such as castling, en passant, double-pawn,
    capture, and promotion.

    We do this by matching against legal moves generated by the engine.
    """
    uci = uci.strip()
    ...
    # Let the engine decide the exact flags; select the matching legal move.
    ...
    raise ValueError(
        f"Illegal/unknown UCI in this position: {uci!r} "
